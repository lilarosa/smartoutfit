...
async function loadClothes() {
    ...
    try {
        ...
        els.grid.innerHTML = `<div class="image-placeholder">Backend connection failed</div>`;
        els.recentGrid.innerHTML = `<div class="image-placeholder">Backend connection failed</div>`;
        showToast("Backend temporarily unavailable");
    }
}
